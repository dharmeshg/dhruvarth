        ...
        <div class="pcoded-content">
            <div class="pcoded-inner-content">
                ...
                <ul>
                    ...
                    <li class="breadcum-item active"><a href="javascript:;"> Metal Rate </a></li>
                </ul>
            </div>
                <div class="main-body">
                            ...
                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card Recent-Users mb-4">
                                    <div class="card-header">
                                        ...
                                        <a href="" class="add-article-btn" data-bs-toggle="modal" data-bs-target="#metal_rate_modal">Add Metal Rate</a>
                                    </div>
	                                        ...
	                                        <div class="mb-3 filter-sec">
	                                            <div class="row input_group">
	                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3">
	                                                    <label>Search <span class="info_label" data-bs-toggle="tooltip" data-bs-placement="right" title="Please search Metal Purity" ><i class="fa fa-info-circle" aria-hidden="true"></i></span></label>
        ...
        <div class="modal-body">
            <form id="add_metal_rate" action="" method="" data-parsley-validate="" onsubmit="return false">
                ...
                <div class="input_group">
                    <div class="mb-3">
                        <label class="form-label" for="exampleFormControlTextarea1">Purity <span class="info_label" data-bs-toggle="tooltip" data-bs-placement="right" title="Please select Metal Purity From Drop-Down" ><i class="fa fa-info-circle" aria-hidden="true"></i></span></label>
                ...
                <div class="mb-3">
                    <label class="form-label" for="exampleFormControlInput1">Rate (Price Per Gram) <span class="info_label" data-bs-toggle="tooltip" data-bs-placement="right" title="Please enter Metal Rate Per Gram" ><i class="fa fa-info-circle" aria-hidden="true"></i></span><span style="color: red;margin: 0;">*</label>
