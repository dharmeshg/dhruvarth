...
<rss xmlns:g="http://base.google.com/ns/1.0" version="2.0">
    <channel>
        ...
        @if(isset($mergedProducts) && count($mergedProducts) > 0)
        @foreach($mergedProducts as $product)
        @php
         $imageType = $product instanceof App\Models\Product ? 'simple' : 'variant';
            $image = App\Models\ProductImage::where('product_id',$product->id)->where('type',$imageType)->first();
