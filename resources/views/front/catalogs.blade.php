                                    ...
                                    <div class="col-12">
                                        <article>
                                            <div class="product-images">
                                                <div class="new-collections-tagline number-text">@if(isset($catalogs) && count($catalogs) > 0) ({{count($catalogs)}}) @else (0) @endif PRODUCTS</div>
                                                ...
                                                @endphp
                                                <a href="{{route('front.catalogue')}}" aria-label="Product Image">
                                            ...
                                            <div class="product-details-section">
                                                <div class="inner-section">
                                                    <a href="{{route('front.catalogue')}}" aria-label="{{ isset($catalogs_value->name) ? $catalogs_value->name : '' }}">
