...
<section class="inner-banner-section">
    ...
    <div class="banner-content">
        <div class="container-md">
            <div class="row">
                <div class="col-12">
                    <h1>{{isset($collection->name) ? $collection->name : ''}}</h1>
                </div>
            </div>
        </div>
   </div>
        ...
        <div class="row align-items-center">
            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 left-side">
            	<span class="d-flex page-nav-text">
                    ...
                    <a href="{{route('front.collection')}}" aria-label="home icon">Collections</a> <span class="dash-line">/</span>
                    <a aria-label="home icon">{{isset($collection->name) ? $collection->name : ''}}</a>
                </span>
...
<section class="common-padding common-section catalogues-section product-box-section catalogues-page-product">
    <div class="container-md" id="all_catalogues">
		...
		<div class="row" id="catalogue_list">
			@php
				$catalogues = $collection_catalogues;
			@endphp
			@if(isset($catalogues) && count($catalogues) > 0)
				@foreach($catalogues as $cataloguev)
					
					@php
					$catalogue = App\Models\Catalogue::where('id', $cataloguev)->first();
					if(!$catalogue){
						continue;
					}
