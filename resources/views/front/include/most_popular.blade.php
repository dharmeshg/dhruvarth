@php
    $most_added_products = App\Models\Product::where('visiblity',1)->where(function ($query) {
                      $query->where('publish_status', '!=', 'draft')
                            ->orWhereNull('publish_status');
                  })->take(5)->get();
@endphp

@if(isset($most_added_products) && count($most_added_products) > 0)
            ...
            <section class="common-padding common-section most-popular-section product-box-section">
                <div class="container-md">
                    ...
                    <div class="row">
                        ...
                        <div class="product-carousel owl-loaded" id="most-popular-slider">
                            @foreach($products as $products_value)
                            <div class="col-12 most-popular-each" data-product-type="{{ isset($products_value->is_public) && $products_value->is_public == 1 ? 'public' : 'private' }}">
                                <article>
