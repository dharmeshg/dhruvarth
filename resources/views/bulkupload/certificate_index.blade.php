        ...
        <div class="pcoded-inner-content">
            ...
            <div class="custom_breadcum">
                <ul>
                    ...
                    <li class="breadcum-item active"><a href="javascript:;">Product Certificate Upload </a></li>
                </ul>
            </div>
            <!-- [ breadcrumb ] end -->
            <div class="main-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 cpl-sm-12 col-xs-12 add-article form-main-sec ">
                                <div class="Recent-Users">
                                    <h5>Product Certificate Upload</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-3 bulk-img-sec">
                                                <div class="notice_area">
                                                    <h6>Instructions</h6>
                                                    <ul>
                                                        <li>At a time 20 Certificates can be uploaded</li>
                                                        <li>Certificates name has to product SKU. i.e Proudct SKU is JBG0308.So Certificate name will be JBG0308.pdf. </li>
                                                        <li>Certificates Size cant be more than 5MB.</li>
                                                        <li>Images,Pdf,doc and excel files can be upload.</li>
                                                    </ul>
                                                </div>
...
$(document).ready(function() {
    ...
    var myDropzone = new Dropzone("#dropzone_demo", {
        ...
        acceptedFiles: 'image/*,.pdf,.doc,.docx,.xls,.xlsx*', // Accept images only
        addRemoveLinks: true,
        ...
        this.on("error", function(file, response) {
            ...
            if (!file.type.match('(image|video).*') && !['application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'].includes(file.type)) {
            errorMessage = `${file.upload.filename}: Invalid file type. Only images, and certain document types are allowed.`;
            if (!error_messages.includes(errorMessage)) {
                error_messages.push(errorMessage);
            }
            }
    ...
    $(document).on("click", "#upload_all_img", function() {
        ...
        function uploadFile(index) {
            ...
            $.ajax({
                url: '{{ route('bulk.product.certificate.store') }}',
                type: 'POST',
                data: data,
                contentType: false,
                processData: false,
...
<script>
    ...
    function load_images(search_text,status)
    {
        ...
        table = $('#myTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: admin_url + "bulk-product-certificate-list",
                type: 'post',
                data: {
    ...
    $(document).on('click', '.delete', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to delete the Certificate and Also Removed from Product!',
            icon: 'warning',
...
<script>
    $(document).on("click","#download",function() {
        var search_text = $('#search_text').val();
        var status = $('#status_select').val();      
        var url = "{{route('bulk.product.certificate.download')}}";
