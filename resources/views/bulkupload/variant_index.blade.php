        ...
        <div class="pcoded-inner-content">
            ...
            <div class="custom_breadcum">
                <ul>
                    ...
                    <li class="breadcum-item active"><a href="javascript:;">Variant Upload </a></li>
                </ul>
            </div>
            <!-- [ breadcrumb ] end -->
            <div class="main-body">
                    ...
                    <!-- [ Main Content ] start -->
                        <div class="row">
                            ...
                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 cpl-sm-12 col-xs-12 add-article form-main-sec mt-3">
                                <div class="Recent-Users">
                                    <h5>Bulk Variant Upload</h5>
                                    <form action="{{ route('bulk.variant.store') }}" method="POST" data-parsley-validate="" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-block px-0 py-3">
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <button type="submit" class="common-submit-btn" style="margin-top: 35px;">Upload</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 cpl-sm-12 col-xs-12 add-article form-main-sec mt-3">
                                <div class="Recent-Users">
                                    <h5>Bulk Upload Variant List</h5>
...
<script>
    ...
    var table = $('#myTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: admin_url + "bulk-variant-file-list",
            type: 'post',
            data: {
                _token: token,
            },
    ...
    $(document).on("click",".publish_btn",function() {
        ...
        // Swal.fire({
        //     title: 'Are you sure?',
        //     text: 'You are about to Publish All Variants uploaded by this File!',
        //     icon: 'warning',
        ...
        //         $.ajax({
        //             url: admin_url + "publish-variant-file",
        //             type: "POST",
        //             data: {
        //                 file_id: file_id,
        ...
        $.ajax({
            ...
            success: function(result) {
               if(result.status == 0) {
                    ...
                    if(setalert == 0){
                        var alertmessage = "You are about to Publish All Variants uploaded by this File!";
                    }else{
                        var alertmessage = "You are about to Publish All Variants Without Images!";
                    }
