        ...
        <div class="pcoded-inner-content">
            <div class="custom_breadcum">
                <ul>
                    ...
                    <li class="breadcum-item active"><a href="javascript:;"> Collections</a></li>
                </ul>
            </div>
                                        ...
                                        <div class="mb-3 filter-sec">
                                            <div class="row input_group">
                                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                    <label>Search <span data-bs-toggle="tooltip" data-bs-placement="right" title="Please search from here for collection"><i class="fa fa-info-circle" aria-hidden="true"></i></span></label>
...
<script>
    ...
    $(document).on('click', '#is_featured', function() {
        ...
        $.ajax({
            url: admin_url + "collection-status",
            type: "post",
            data: {
                _token: token,
                isChecked: isChecked,
    ...
    $(document).on('click', '.delete', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to delete the Collection!',
            icon: 'warning',
