                                        ...
                                        <div class="card card-social first_box">
                                            <div class="card-block">
                                                <div class="row">
                                                    ...
                                                    <h5 class="mb-3 dashboard_heading text-center"><span class="heading_class">Customers</span></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                    ...
                                    <a href="{{route('orders.index')}}">
                                        <div class="card card-social second_box">
                                            <div class="card-block">
                                                <div class="row">
                                                    <div class="col text-center mb-3">
                                                        <img src="{{ asset('assets/images/orders.png') }}">
                                                    </div>
                                                    <h5 class="mb-3 dashboard_heading text-center"><span class="heading_class">Orders</span></h5>
                                                </div>
                                            </div>
