    ...
    <div class="row delivery-field-sec-row">
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec state_sec">
                <label for="">State (Multiple) <span data-bs-toggle="tooltip" data-bs-placement="right" title="Please select state"><i class="fa fa-info-circle" aria-hidden="true"></i></span> </label>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec zip_sec">
                <label for="">Post Code / Zip Code (Multiple) <span data-bs-toggle="tooltip" data-bs-placement="right" title="Please enter zip code"><i class="fa fa-info-circle" aria-hidden="true"></i></span> </label>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec">
                <label for="">Duration / Days <span data-bs-toggle="tooltip" data-bs-placement="right" title="Please enter duration"><i class="fa fa-info-circle" aria-hidden="true"></i></span> </label>
                <input type="text" class="form-control" name="p_deliver_duration[{{isset($counter) ? $counter : $key+1}}][]" id="" placeholder="Enter Duration" value="{{ isset($delivery->p_deliver_duration) ? $delivery->p_deliver_duration : ''}}">
            </div>
        </div>
    </div>
</div>