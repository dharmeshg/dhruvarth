    ...
    <div class="row each-diamond-details">
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec">
                ...
                <select name="attr_type[]" class="form-control">
                    ...
                    <option value="Lab-Grown">Cultured</option>
                    <option value="Lab-Grown">Saltwater</option>
                    <option value="Lab-Grown">Imitation</option>
                </select>
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 caret_sec">
            <div class="form-sec">
                ...
                <input type="number" step="0.0001" class="form-control attr_carat" name="attr_diamond_caret[]" id="" placeholder="Enter Carat">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec">
                ...
                <select name="attr_gemstone[]" class="form-control">
                    ...
                    <option value="Sapphire Yellow">Sapphire Yellow</option>
                    <option value="Sapphire Blue">Sapphire Blue</option>
                    <option value="Sapphire Pink">Sapphire Pink</option>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec">
                ...
                <input type="text" class="form-control attr_total_dimond" name="attr_total_diamond_count[]" id="" placeholder="Enter Total Diamonds Count">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 total_wight_sec">
            <div class="form-sec">
                ...
                <input type="text" class="form-control total_weight" name="attr_total_diamond_wight[]" id="" placeholder=" Enter Total Diamond Weight">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec caret_sec">
                ...
                <input type="text" class="form-control price_caret" name="attr_diamond_per_carat[]" id="" placeholder="Enter Diamonds Price Per Carat">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 total_final_sec">
            <div class="form-sec diamonds_total_sec">
                ...
                <input type="text" class="form-control final_total" name="attr_final_diamond_price[]" id="" placeholder="Enter Final Diamond Price">
            </div>
        </div>
    ...
    <div class="row each-diamond-details">
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec">
                ...
                <select name="attr_gemstone_color[]" class="form-control">
                    ...
                    <option value="Green">Green</option>
                    <option value="London Blue">London Blue</option>
                    ...
                    <option value="Swiss Blue">Swiss Blue</option>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 gemstone_caret_sec">
            <div class="form-sec">
                ...
                <input type="number" step="0.0001" class="form-control attr_gemstone_carat" name="attr_gemstone_caret[]" id="" placeholder="Enter Carat">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec">
                ...
                <input type="text" class="form-control attr_total_gemstone" name="attr_gemstone_total_gem_count[]" id="" placeholder="Enter Total Gemstone Count">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 total_gemstone_wight_sec">
            <div class="form-sec">
                ...
                <input type="text" class="form-control total_gemstone_weight" name="attr_gemstone_total_wight[]" id="" placeholder="Enter Total Gemstone Weight">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec gemstone_caret_sec">
                ...
                <input type="text" class="form-control gemstone_price_caret" name="gemstone_price_carat[]" id="" placeholder="Enter Gemstone Price Per Carat">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 gemstone_total_final_sec">
            <div class="form-sec gemstone_total_sec">
                ...
                <input type="text" class="form-control gemstone_final_total" name="gemstone_final_total[]" id="" placeholder="Enter Final Gemstone Price">
            </div>
        </div>
    ...
    <div class="row each-diamond-details">
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 pearl_caret_sec">
            <div class="form-sec">
                ...
                <input type="number" step="0.0001" class="form-control attr_pearl_carat" name="attr_pearl_caret[]" id="" placeholder="Enter Carat">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec">
                ...
                <select name="attr_pearl_gem[]" class="form-control">
                    ...
                    <option value="Khakho">Khakho</option>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec">
                ...
                <select name="attr_pearl_grade[]" class="form-control">
                    ...
                    <option value="Hanadama">Hanadama</option>
                </select>
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec">
                ...
                <input type="text" class="form-control attr_total_pearl" name="attr_pearl_total_gem_count[]" id="" placeholder="Enter Total Pearl Count">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 total_pearl_wight_sec">
            <div class="form-sec">
                ...
                <input type="text" class="form-control total_pearl_weight" name="attr_pearl_total_wight[]" id="" placeholder="Enter Total Pearl Weight">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-sec pearl_caret_sec">
                ...
                <input type="text" class="form-control pearl_price_caret" name="pearl_price_carat[]" id="" placeholder="Enter Pearl Price Per Carat">
            </div>
        </div>
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 pearl_total_final_sec">
            <div class="form-sec pearl_total_sec">
                ...
                <input type="text" class="form-control pearl_final_total" name="pearl_final_total[]" id="" placeholder="Enter Final Pearl Price">
            </div>
        </div>
