        ...
        <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px; ">
            <tr>
                <td style="padding: 20px 0; text-align: center; background-color: #ffffff;border-bottom: 1px solid var(--theme-orange-red);">
                    <img src="{{$data['business_logo']}}" border="0">
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td bgcolor="#ffffff" style="padding: 15px;">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="font-size: 14px;color: #555555; padding: 10px; text-align: left; width: 100%;">
                               <p>Hi,</br>
                                
                                You have requested Verification OTP. Please find Your OTP.</p>
                                <h2>{{$data['otp']}}</h2>
                                
                                <p>Do not share this OTP with anyone.</p>
                                <p></p>
                                <p></p>
                                <p>Regards, <br> {{$data['business_name']}} Team</p>
                            </td>
