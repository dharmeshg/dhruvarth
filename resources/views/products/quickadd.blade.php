                                    ...
                                    <div class="row">
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 d-flex align-items-center">
                                            ...
                                            <div id="image-preview-container" class="d-flex" >
                                             ...
                                             @endforeach
                                             @else
                                             <img src="{{asset('assets/images/user/img-demo_1041.jpg')}}" class="img-fluid preview_image" id="large-item-img-output-single">
                                             <input type="hidden" id="existing_image_count" value="0">
                                             @endif
                                         </div>
                                     </div>
                                 </div>
                        ...
                        <div class="row">
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 Fixed_price_data" >
                                <div class="form-sec">
                                    ...
                                    <input type="hidden" class="form-control" name="publish" id="p_pricetype" placeholder="Enter Price" value="yes">
