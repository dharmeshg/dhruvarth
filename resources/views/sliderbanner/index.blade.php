        ...
        <div class="pcoded-inner-content">
            <div class="custom_breadcum">
                <ul>
                    ...
                    <li class="breadcum-item active"><a href="javascript:;"> Slider Banner</a></li>
                </ul>
            </div>
            <div class="main-body">
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card Recent-Users mb-4">
                                <div class="card-header">
                                    ...
                                    <a href="{{route('sliderbanner.add')}}" class="add-article-btn">Add Slider Banner</a>
                                </div>
...
@section('script')
    ...
    $(document).on('click', '.pinned_chekbox', function() {
        ...
        var isChecked = $(this).is(':checked');
        $.ajax({
            url: admin_url + "pinned-slider-banner",
            type: "post",
            data: {
                _token: token,
                isChecked: isChecked,
