...
<div class="pcoded-wrapper">
                            ...
                            <div class="card Recent-Users mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                                        <form id="addcategory" action="{{ route('families.save') }}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="exampleFormControlTextarea1">Image/Icon</label>
                                                    <div class="upload-img-sec">
                                                        <input type="hidden" name="cat_img" id="img_id" value="">
                                                        <div class="image_preview_div">
                                                        <img src="{{ asset('assets/images/user/img-demo_1041.jpg') }}" alt="" id="profile_avtar" class="profile-img" id="profile_avtar"> 
    ...
    $(document).on('click', '.delete', function(e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to delete the Family!',
            icon: 'warning',
    ...
    $(document).on("click", ".edit", function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#img_id").val(data.image);
                $("#profile_avtar").attr('src', data.url);
    ...
    $(document).on('click', '#is_featured', function() {
        ...
        $.ajax({
            url: admin_url + "check/featured-family",
            type: "post",
            data: {
                _token: token,
                isChecked: isChecked,
