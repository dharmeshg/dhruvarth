...
class BulkImport implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach ($rows as $r_key => $row) {
            ...
            $metal_purity = isset($row[29]) && $row[29] != '' ? $row[29] : null;
            $metal_color = isset($row[30]) && $row[30] != '' ? $row[30] : null;
            $metal_weight = isset($row[31]) && $row[31] != '' ? $row[31] : null;
            $metal_unit = isset($row[32]) && $row[32] != '' ? $row[32] : null;
            $laboratory = isset($row[33]) && $row[33] != '' ? $row[33] : null;
            $certificate_no = isset($row[34]) && $row[34] != '' ? $row[34] : null;
            $certificate_link = isset($row[35]) && $row[35] != '' ? $row[35] : null;
            $visiblity = isset($row[36]) && $row[36] != '' ? $row[36] : null;
            $draft = isset($row[37]) && $row[37] != '' ? $row[37] : null;
            $price_type = isset($row[38]) && $row[38] != '' ? $row[38] : null;
            $diamond_data['nature'] = isset($row[39]) && $row[39] != '' ? $row[39] : null;
            $diamond_data['fancy_color'] = isset($row[40]) && $row[40] != '' ? $row[40] : null;
            $diamond_data['color'] = isset($row[41]) && $row[41] != '' ? $row[41] : null;
            $diamond_data['carat'] = isset($row[42]) && $row[42] != '' ? $row[42] : null;
            $diamond_data['shape'] = isset($row[43]) && $row[43] != '' ? $row[43] : null;
            $diamond_data['clarity'] = isset($row[44]) && $row[44] != '' ? $row[44] : null;
            $diamond_data['cut'] = isset($row[45]) && $row[45] != '' ? $row[45] : null;
            $diamond_data['setting'] = isset($row[46]) && $row[46] != '' ? $row[46] : null; 
            $diamond_data['total_count'] = isset($row[47]) && $row[47] != '' ? $row[47] : null; 
            $diamond_data['price_per_carat'] = isset($row[48]) && $row[48] != '' ? $row[48] : null; 
            $pearl_data['nature'] = isset($row[49]) && $row[49] != '' ? $row[49] : null;
            $pearl_data['color'] = isset($row[50]) && $row[50] != '' ? $row[50] : null;
            $pearl_data['carat'] = isset($row[51]) && $row[51] != '' ? $row[51] : null;
            $pearl_data['pearl'] = isset($row[52]) && $row[52] != '' ? $row[52] : null;
            $pearl_data['shape'] = isset($row[53]) && $row[53] != '' ? $row[53] : null;
            $pearl_data['grade'] = isset($row[54]) && $row[54] != '' ? $row[54] : null;
            $pearl_data['setting'] = isset($row[55]) && $row[55] != '' ? $row[55] : null; 
            $pearl_data['total_count'] = isset($row[56]) && $row[56] != '' ? $row[56] : null; 
            $pearl_data['price_per_carat'] = isset($row[57]) && $row[57] != '' ? $row[57] : null; 
            $gemstone_data['gemstone'] = isset($row[58]) && $row[58] != '' ? $row[58] : null;
            $gemstone_data['nature'] = isset($row[59]) && $row[59] != '' ? $row[59] : null;
            $gemstone_data['color'] = isset($row[60]) && $row[60] != '' ? $row[60] : null;
            $gemstone_data['carat'] = isset($row[61]) && $row[61] != '' ? $row[61] : null;
            $gemstone_data['shape'] = isset($row[62]) && $row[62] != '' ? $row[62] : null;
            $gemstone_data['clarity'] = isset($row[63]) && $row[63] != '' ? $row[63] : null;
            $gemstone_data['cut'] = isset($row[64]) && $row[64] != '' ? $row[64] : null;
            $gemstone_data['setting'] = isset($row[65]) && $row[65] != '' ? $row[65] : null; 
            $gemstone_data['total_count'] = isset($row[66]) && $row[66] != '' ? $row[66] : null; 
            $gemstone_data['price_per_carat'] = isset($row[67]) && $row[67] != '' ? $row[67] : null; 
            $price_breakup = isset($row[68]) && $row[68] != '' ? $row[68] : null;
            $fix_price = isset($row[69]) && $row[69] != '' ? $row[69] : null;
            $fix_discount_type = isset($row[70]) && $row[70] != '' ? $row[70] : null;
            $fix_discount = isset($row[71]) && $row[71] != '' ? $row[71] : null;
            $making_calculation = isset($row[72]) && $row[72] != '' ? $row[72] : null;
            $fix_making_charge = isset($row[73]) && $row[73] != '' ? $row[73] : null;
            $making_charge_percentage = isset($row[74]) && $row[74] != '' ? $row[74] : null;
            $making_charge_d_type = isset($row[75]) && $row[75] != '' ? $row[75] : null;
            $making_charge_discount = isset($row[76]) && $row[76] != '' ? $row[76] : null;
            $diamond_d_type = isset($row[77]) && $row[77] != '' ? $row[77] : null;
            $diamond_discount = isset($row[78]) && $row[78] != '' ? $row[78] : null;
            $pearl_d_type = isset($row[79]) && $row[79] != '' ? $row[79] : null;
            $pearl_discount = isset($row[80]) && $row[80] != '' ? $row[80] : null;
            $gem_d_type = isset($row[81]) && $row[81] != '' ? $row[81] : null;
            $gem_discount = isset($row[82]) && $row[82] != '' ? $row[82] : null;
            $other_charge = isset($row[83]) && $row[83] != '' ? $row[83] : null;
            $other_d_type = isset($row[84]) && $row[84] != '' ? $row[84] : null;
            $other_discount = isset($row[85]) && $row[85] != '' ? $row[85] : null;
            $national_tax = isset($row[86]) && $row[86] != '' ? $row[86] : null;
            $minimum_amount = isset($row[87]) && $row[87] != '' ? $row[87] : null;
            $payment_g = isset($row[88]) && $row[88] != '' ? $row[88] : null;
            $cod = isset($row[89]) && $row[89] != '' ? $row[89] : null;
            $ccod = isset($row[90]) && $row[90] != '' ? $row[90] : null;
            $metatitle = isset($row[91]) && $row[91] != '' ? $row[91] : null;
            $metades = isset($row[92]) && $row[92] != '' ? $row[92] : null;
            $is_public = isset($row[93]) && $row[93] != '' ? $row[93] : null;
            ...
            // if(isset($sku) && $sku != null && $sku != '')
            // {
            //     $variant_sku = VariantProduct::where("p_sku",trim($sku))->first();
            //     if(isset($variant_sku) && $variant_sku != null)
            //     {
            //         $row[94] .= 'Any Variant Having Same SKU |';
            //         $validData = false; 
            //     }
            // }
            if(isset($family) && $family != null)
            {
                ...
                if($family_check && $family_check != null)
                {
                    ...
                    $row[94] .= 'Product Family not Found|';
                    $validData = false;
                }
            }
            if(empty($status))
            ...
            if(isset($status) && $status != '')
            {
                if (!in_array($status, ['ready_stock', 'by_order'])) {
                    $row[94] .= 'Invalid Status |';
                    $validData = false;
                } 
            }
            if(empty($title))
            {
                $row[94] .= 'Product Title* |';
                $validData = false;
            }
            if(!empty($unit))
            {
            ...
            if(!empty($measurements_unit))
            {
                ...
                if($measurements_unit_check && $measurements_unit_check != null)
                {
                    ...
                    $row[94] .= 'Measurement Unit Not Found|';
                    $validData = false;
                }
            }
            if(!empty($quantity_unit))
            {
                ...
                if($quantity_unit_check && $quantity_unit_check != null)
                {
                    ...
                    $row[94] .= 'Quantity Unit Not Found|';
                    $validData = false;
                }
            }
            if(!empty($gross_weight_unit))
            {
                ...
                if($gross_weight_unit_check && $gross_weight_unit_check != null)
                {
                    ...
                    $row[94] .= 'Gross Weight Unit Not Found|';
                    $validData = false;
                }
            }
            if(!empty($net_weight_unit))
            {
                ...
                if($net_weight_unit_check && $net_weight_unit_check != null)
                {
                    ...
                    $row[94] .= 'Net Weight Unit Not Found|';
                    $validData = false;
                }
            }
            if(!empty($made_in))
            {
                ...
                if($made_in_check && $made_in_check != null)
                {
                    ...
                    $row[94] .= 'Made In Not Found|';
                    $validData = false;
                }
            }
            if(!empty($metal_purity))
            {
                $metal_purity_check = MetalPurity::whereRaw('LOWER(title) = ?', [trim(strtolower($metal_purity))])->first();
                if($metal_purity_check && $metal_purity_check != null)
                {
                    $metal_purity_id = $metal_purity_check->id;
                }else{
                    $row[94] .= 'Metal Purity Not Found|';
                    $validData = false;
                }
            }
            if(!empty($metal_color))
            {
                $metal_color_check = Metal::whereRaw('LOWER(title) = ?', [trim(strtolower($metal_color))])->first();
                if($metal_color_check && $metal_color_check != null)
                {
                    $metal_color_id = $metal_color_check->id;
                }else{
                    $row[94] .= 'Metal Color Not Found|';
                    $validData = false;
                }
            }
            if(!empty($metal_unit))
            {
                $metal_unit_check = WUnit::whereRaw('LOWER(title) = ?', [trim(strtolower($metal_unit))])->first();
                if($metal_unit_check && $metal_unit_check != null)
                {
                    $metal_unit_id = $metal_unit_check->title;
                }else{
                    $row[94] .= 'Metal Weight Not Found |';
                    $validData = false;
                }
            }
            if(!empty($laboratory))
            ...
            if(isset($fix_discount_type) && $fix_discount_type != '')
            {
                if (!in_array($fix_discount_type, ['percentage', 'price', 'Percentage', 'Price'])) {
                    $row[94] .= 'Invalid Fix Price Discount Type |';
                    $validData = false;
                } 
            }
            if(isset($making_calculation) && $making_calculation != '')
            {
                if (!in_array($making_calculation, ['percentage', 'price', 'Percentage', 'Price'])) {
                    $row[94] .= 'Invalid Making charge Calculation Type |';
                    $validData = false;
                } 
            }
            if(isset($making_charge_d_type) && $making_charge_d_type != '')
            {
                if (!in_array($making_charge_d_type, ['percentage', 'price', 'Percentage', 'Price'])) {
                    $row[94] .= 'Invalid Making Charge Discount type |';
                    $validData = false;
                } 
            }
            if(isset($diamond_d_type) && $diamond_d_type != '')
            {
                if (!in_array($diamond_d_type, ['percentage', 'price', 'Percentage', 'Price'])) {
                    $row[94] .= 'Invalid Diamond Discount type |';
                    $validData = false;
                } 
            }
            if(isset($pearl_d_type) && $pearl_d_type != '')
            {
                if (!in_array($pearl_d_type, ['percentage', 'price', 'Percentage', 'Price'])) {
                    $row[94] .= 'Invalid Pearl Discount type |';
                    $validData = false;
                } 
            }
            if(isset($gem_d_type) && $gem_d_type != '')
            {
                if (!in_array($gem_d_type, ['percentage', 'price', 'Percentage', 'Price'])) {
                    $row[94] .= 'Invalid Gemstone Discount type |';
                    $validData = false;
                } 
            }
            if(isset($other_d_type) && $other_d_type != '')
            {
                if (!in_array($other_d_type, ['percentage', 'price', 'Percentage', 'Price'])) {
                    $row[94] .= 'Invalid Orher Charge Discount type |';
                    $validData = false;
                } 
            }
            if(isset($payment_g) && $payment_g != '')
            {
                if (!in_array($payment_g, ['yes', 'no','Yes', 'No'])) {
                    $row[94] .= 'Invalid Payment Gateway Selection |';
                    $validData = false;
                } 
            }
            if(isset($cod) && $cod != '')
            ...
            if(isset($is_public) && $is_public != '')
            {
                if (!in_array($is_public, ['1', '0'])) {
                    $row[94] .= 'Invalid Is Public Product Status |';
                    $validData = false;
                } 
            }
                ...
                if(isset($diamond_data['nature']) && $diamond_data['nature'] != '')
                {
                    ...
                    if (isset($diamond_data['fancy_color']) && $diamond_data['fancy_color'] != null) {
                        ...
                        if (count($d_fancy_missing_values) > 0) {
                            $row[94] .= 'Diamond Fancy Color Not Found|';
                            $validData = false;
                            $d_m_count++;
                        } else {
                    ...
                    if (isset($diamond_data['color']) && $diamond_data['color'] != null) {
                        ...
                        if (count($d_color_missing_values) > 0) {
                            $row[94] .= 'Diamond Color Not Found|';
                            $validData = false;
                            $d_m_count++;
                        } else {
                    ...
                    if (isset($diamond_data['shape']) && $diamond_data['shape'] != null) {
                        ...
                        if (count($d_shape_missing_values) > 0) {
                            $row[94] .= 'Diamond Shape Not Found|';
                            $validData = false;
                            $d_m_count++;
                        } else {
                    ...
                    if (isset($diamond_data['clarity']) && $diamond_data['clarity'] != null) {
                        ...
                        if (count($d_clarity_missing_values) > 0) {
                            $row[94] .= 'Diamond Clarity Not Found|';
                            $validData = false;
                            $d_m_count++;
                        } else {
                    ...
                    if (isset($diamond_data['setting']) && $diamond_data['setting'] != null) {
                        ...
                        if (count($d_setting_missing_values) > 0) {
                            $row[94] .= 'Diamond Setting Not Found|';
                            $validData = false;
                            $d_m_count++;
                        } else {
                ...
                if(isset($pearl_data['nature']) && $pearl_data['nature'] != '')
                {
                    ...
                    if (isset($pearl_data['setting']) && $pearl_data['setting'] != null) {
                        ...
                        if (count($p_setting_missing_values) > 0) {
                            $row[94] .= 'Pearl Setting Not Found|';
                            $validData = false;
                            $p_m_count++;
                        } else {
            ...
            if(isset($gemstone_data) && $gemstone_data != '')
            {
                ...
                if(isset($gemstone_data['gemstone']) && $gemstone_data['gemstone'] != '')
                {
                    ...
                    if (count($g_gemstone_missing_values) > 0) {
                        $row[94] .= 'Gemstone Value Not Found|';
                        $validData = false;
                        $g_m_count++;
                    } else {
                    ...
                    if (isset($gemstone_data['nature']) && $gemstone_data['nature'] != null) {
                        ...
                        if (count($g_nature_missing_values) > 0) {
                            $row[94] .= 'Gemstone Type Not Found|';
                            $validData = false;
                            $g_m_count++;
                        } else {
                    ...
                    if (isset($gemstone_data['color']) && $gemstone_data['color'] != null) {
                        ...
                        if (count($g_color_missing_values) > 0) {
                            $row[94] .= 'Gemstone Color Not Found|';
                            $validData = false;
                            $g_m_count++;
                        } else {
                    ...
                    if (isset($gemstone_data['shape']) && $gemstone_data['shape'] != null) {
                        ...
                        if (count($g_shape_missing_values) > 0) {
                            $row[94] .= 'Gemstone Shape Not Found|';
                            $validData = false;
                            $g_m_count++;
                        } else {
                    ...
                    if (isset($gemstone_data['clarity']) && $gemstone_data['clarity'] != null) {
                        ...
                        if (count($g_clarity_missing_values) > 0) {
                            $row[94] .= 'Gemstone Clarity Not Found|';
                            $validData = false;
                            $g_m_count++;
                        } else {
                    ...
                    if (isset($gemstone_data['setting']) && $gemstone_data['setting'] != null) {
                        ...
                        if (count($g_setting_missing_values) > 0) {
                            $row[94] .= 'Gemstone Setting Not Found|';
                            $validData = false;
                            $g_m_count++;
                        } else {
            ...
            if(isset($validData) && $validData == true)
            {
                ...
                $data['p_metal_purity'] = isset($metal_purity_id) ? $metal_purity_id : null;
                $data['p_metal_weigth'] = isset($metal_weight) ? $metal_weight : null;
                $data['p_metal_weight_unit'] = isset($metal_unit_id) ? $metal_unit_id : null;
                $data['p_metal_color'] = isset($metal_color_id) ? $metal_color_id : null;
                ...
                $data['is_public'] = isset($is_public) ? $is_public : '1';
                ...
                if(isset($draft) && ($draft == 'yes' || $draft == 'Yes'))
                {
                    $d_draft = 'draft';
                }else{
                    $d_draft = null;
                ...
                $data['publish_status'] = isset($d_draft) ? $d_draft : null;
                ...
                $duplicate = Product::where("p_sku",trim($sku))->first();
                if(!$duplicate)
                {
