...
class Category extends Model
{
    ...
    {
        return $this->hasMany(Product::class, 'p_category', 'id');
    }
    public function gender_product($name)
    {
        return Product::where('p_gender',$name)->where('p_category', $this->id)->orWhere('p_sec_category', $this->id)->get()->count();
    }
       public function product_category($name)
    {
        return Product::where('p_family',$name)->where('p_category', $this->id)->get()->count();
    }
